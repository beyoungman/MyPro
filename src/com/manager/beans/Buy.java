...
public class Buy implements Serializable {
	...
	public Buy(int buy_id, Date date, String customer, String goods,
	...
	public String toString() {
		return "Buy [buy_id=" + buy_id + ", date=" + date + ", customer="
				+ customer + ", goods=" + goods + ", weight=" + weight
				+ ", weigh_money=" + weigh_money + ", money=" + money
